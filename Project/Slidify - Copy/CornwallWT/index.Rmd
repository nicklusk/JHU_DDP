...
cat('<iframe src="cornwall.html" STYLE="width:80%;height:80%"> </iframe>')
includeHTML("cornwall.html")
```
...
For example, if a location selected were on the windy north coast, that had id25 `r id=25`in the atlas csv file, and if a tower height of h=50 m `r h=50` had been selected, then the windspeed at that height would be found to be:
