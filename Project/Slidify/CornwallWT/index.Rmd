...
#     addRectangles(~lon, ~lat,~lon+0.014,~lat+0.009,layerId=~id,group=NULL,stroke=FALSE,color="blue", weight = 1, opacity = 0, fill = TRUE,fillColor = ~reds(ws25),fillOpacity = 0.3)%>%
